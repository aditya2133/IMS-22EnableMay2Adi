 ...
 */
public enum Action {
	CREATE("To save a new entity into the database"), READALL("To read an entity from the database"),
	READ("Return info for certain query"),UPDATE("To change an entity already in the database"), DELETE("To remove an entity from the database"),
